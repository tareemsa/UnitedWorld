                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ action('UserController@StoreUser') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <label for="phone" class="col-md-4 col-form-label text-md-right">{{ __('Country') }}</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <!-- All countries -->
                                    <select id="category"  class="form-control @error('category') is-invalid @enderror" name="category_id" value="{{ old('category_id') }}" required autocomplete="category">
