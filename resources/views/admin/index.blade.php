                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <!-- /.progress-group -->
                                        <div class="progress-group">
                                            <span class="progress-text">Info 03</span>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                <div class="table-responsive">
                                    <table class="table m-0">
                                        ...
                                        @for( $i=0; $i < 7; $i++)
                                        <tr>
                                            <td><a href="pages/examples/invoice.html">US9842</a></td>
                                            <td>abdallah sasa</td>
                            ...
                            <div class="card-footer clearfix">
                                <a href="javascript:void(0)" class="btn btn-sm btn-info float-left">Add New Member</a>
                                <a href="javascript:void(0)" class="btn btn-sm btn-secondary float-right">View All Members</a>
                            </div>
                            <!-- /.card-footer -->
                        </div>
                        <!-- /.card -->
                    ...
                    <div class="col-md-4">
                                ...
                                <ul class="products-list product-list-in-card pl-2 pr-2">
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title">Job 01
                      ...
                      Job 01 Description
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title">Job 02
                                                <span class="badge badge-warning float-right">$1800</span></a>
                                            <span class="product-description">
                      Job 02 Description
                      </span>
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title">Job 03
                                                <span class="badge badge-warning float-right">$1800</span></a>
                                            <span class="product-description">
                      Job 03 Description
                      </span>
                                    ...
                                    <li class="item">
                                        ...
                                        <div class="product-info">
                                            <a href="javascript:void(0)" class="product-title">Job 04
                                                <span class="badge badge-warning float-right">$1800</span></a>
                                            <span class="product-description">
                      Job 04 Description
                      </span>
